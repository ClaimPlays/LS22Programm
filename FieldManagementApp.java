...
public class FieldManagementApp extends Application {
    ...
    private final String[] cropTypes = {
            ...
            "Zuckerrübe", "Rote Beete", "Karotte", "Pastinake", "Baumwolle", "Langkornreis", "Reis", "Grüne Bohne",
            "Erbse", "Spinat", "Zuckerrohr", "Holzhackschnitzel", "Zuckerrübenschnitzel", "Silage", "Gras-Windel",
            "Trockenes Gras-Windel", "Stroh", "Geschnittenes Weizen", "Geschnittenes Gerste", "Geschnittenes Hafer",
            "Geschnittenes Raps", "Geschnittenes Sojabohne", "Traube", "Olive", "Saatgut", "Stein", "Mist",
            "Gülle", "Futter", "Häckselgut", "Pappel", "Schnee", "Streusalz", "Dünger", "Schweinefutter", "Plane",
            "Kalk", "Mineralisches Futter", "Leinsamen"
    };

    @Override
    public void start(Stage primaryStage) {
        primaryStage.setTitle("Felder Übersicht");

        // Überschrift erstellen
        Label titleLabel = new Label("Felder Management");
    ...
    private boolean hasAllRequiredCropsSelected(String field) {
        // Beispiel: Definiere die erforderlichen Folgefrüchte für ein Feld
        List<String> requiredCrops = new ArrayList<>();
        requiredCrops.add("Weizen");
        requiredCrops.add("Gerste");
        requiredCrops.add("Raps");

        // Hole die aktuellen Früchte des Feldes
        ...
        // Überprüfe, ob alle erforderlichen Folgefrüchte ausgewählt sind
        return requiredCrops.contains(currentCrop);
    }
    ...
    private void updateTilePane() {
        ...
        for (String field : fieldListData) {
            ...
            // Überprüfe, ob alle Folgefrüchte ausgewählt sind
            if (!hasAllRequiredCropsSelected(field)) {
                fieldBox.setStyle("-fx-background-color: #ffcccc;"); // Rot markieren
            } else {
                fieldBox.setStyle("-fx-background-color: #ffffff;"); // Standardfarbe
            }
    ...
    private void handleFieldSelection(VBox fieldBox, String field) {
        ...
        fieldBox.setStyle("-fx-border-color: blue; -fx-border-width: 2; -fx-background-color: #f0f0f0;");
